    ...
    if ($id > 0)
    {
        ...
        */
        ...
        if ($action == 'valid')
        {
            ...
            $ret=$form->form_confirm($_SERVER["PHP_SELF"].'?id='.$object->id, $langs->trans('ValidateBill'), $langs->trans('ConfirmValidateBill', $object->getNextNumRef($socid)), 'confirm_valid', $formquestion, 0, 1, 240);
            if ($ret == 'html') print '<br>';
        }
