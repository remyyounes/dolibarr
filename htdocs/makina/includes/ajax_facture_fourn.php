...
/**
 *       \file       htdocs/stockoperation/ajax_facture_fourn.php
 *       \brief      File to return Ajax response on facture_fourn list request
 */
...
$searchkey = $_GET[$htmlname];
$outjson = true;
require_once(DOL_DOCUMENT_ROOT."/makina/class/html.form2.class.php");
$form2 = new Form2($db);
$arrayresult = $form2->select_factures_fournisseurs_do($_GET["socid"],$selected,$htmlname,"",$searchkey,$status,$outjson);
