...
function initSearchButtons() {
	...
	var searchBtns = document.querySelectorAll(".autocomplete_searchbtn");
	var numBtns = searchBtns.length;
...
function autocomplete_searchbtn(e) {
	var searchBtn = $(e.target);
	ajaxInput = searchBtn.previous("input");

}

function showAll(obj) {
	var ajaxInput = $(obj).prev('input');
	ajaxInput.focus();
	ajaxInput.autocomplete( "search" , ' ' )
	
	return;
	var event = new Event('ondatachange');
	ajaxInput.trigger(event);
}
